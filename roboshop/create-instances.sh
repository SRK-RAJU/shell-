...
if [ $COUNT -eq 0 ]; then
aws ec2 run-instances --image-id ami-0bb6af715826253bf--instance-type t3.micro  --security-group-ids sg-063120a81cc0aff8a   --tag-specifications "ResourceType=instance,Tags=[{Key=Name,Value=$1}]" | jq &>/dev/null
else
